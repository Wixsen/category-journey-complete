...
import { ChevronRight, Minus, Plus, Truck, ShieldCheck, Leaf, MapPin, MessageCircle } from 'lucide-react';
...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            <div className="animate-fade-up">
              ...
              <div className="flex items-center mb-4">
                ...
                <Button
                  ...
                  className="ml-2 text-agri-green border-agri-green hover:bg-agri-green hover:text-white"
                >
      ...
      <ChatWithAI open={chatOpen} onOpenChange={setChatOpen} farmerName={product.farmer} />
