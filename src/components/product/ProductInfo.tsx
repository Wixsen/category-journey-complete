  ...
  return (
    <>
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Badge className="bg-secondary text-secondary-foreground hover:bg-secondary/80">{categoryName}</Badge>
      </div>
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="text-foreground ml-2">{product.weight}</span>
      </div>
