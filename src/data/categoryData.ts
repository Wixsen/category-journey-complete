...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1619566636858-adf3ef46400b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  },
  {
    id: "vegetables",
    name: "Vegetables",
    ...
    image:
      "https://images.unsplash.com/photo-1597362925123-77861d3fbac7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  },
  {
    id: "herbs",
    name: "Herbs",
...
export const products: Product[] = [
  // Crops
  {
    ...
    name: "Organic Wheat",
    description:
      "Freshly harvested organic wheat from our sustainable farms. Perfect for making homemade bread and pastries.",
    price: 3.99,
  ...
  // Fruits
  {
    ...
    price: 1.29,
    image:
      "https://images.unsplash.com/photo-1570913149827-d2ac84ab3f9a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    stock: 100,
  ...
  // Vegetables
  {
    ...
    price: 1.49,
    image:
      "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    stock: 60,
  ...
  // Homemade Goods
  {
    ...
    price: 8.99,
    image:
      "https://images.unsplash.com/photo-1587049352851-8d4e89133924?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    stock: 20,
...
export const getRecommendedProducts = (categoryId: string, productId: string, limit = 4): Product[] => {
  return products.filter((product) => product.categoryId === categoryId && product.id !== productId).slice(0, limit)
}
